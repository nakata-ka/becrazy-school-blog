...
<body class="bg-light">
    ...
    <div class="container-fluid bg-dark px-0">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a @if($link_navi=='home')class='nav-link active' @endif href="/" class="nav-link" >Home</a>
            </li>
            <li class="nav-item">
        ...
        <div class="jumbotron" style="background: url(/img/desktop.jpg)">
            <h1 class="display-4 mt-4">きままにBlog</h1>
            <p class="lead">本ブログは管理人の興味関心ごとについて発信をしていくブログである</p>
        </div>
    </div>
    <!-- main -->
        ...
        <!-- Side -->
            <div class="container-aside col-md-2 side-content" >
                <div class="row bg-light text-center">
                    ...
                    <img src="/img/profile.png" class="d-block mx-auto w-50 img-fluid rounded-circle" style="max-width:100%; height:auto;">
